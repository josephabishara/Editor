...
{
    /// <inheritdoc />
    public partial class AddChannelCRUD : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ChannelReach = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    Distribution = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    ChannelLanguage = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    UnitPrice = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    UnitCurrency = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
